    ...
    <aside className="w-13 md:w-64 bg-gray-800 text-white px-1 md:px-5 pt-1 pb-2 flex flex-col static overflow-y-auto transition-all duration-200">
      <div className="flex p-2 rounded gap-2 items-center border-b border-amber-300">
        <div className="relative">
          <img src={leSen} alt="S" className="w-12" />
        </div>
        <img
          src={enR}
          alt="en'Rapport"
          className="hidden md:block w-23 ml-[-18px]"
        />
      </div>
      ...
      <div
        className="flex items-center justify-center md:justify-start cursor-pointer text-gray-100 hover:text-amber-300 gap-2 mt-auto pt-6 text-4"
