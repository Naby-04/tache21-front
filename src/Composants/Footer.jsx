...
<footer className="bg-blue-50 py-10">
    <div className='flex  flex-col md:flex-row justify-between max-w-7xl mx-auto px-4'>
     ...
     <div className='flex flex-col gap-6'>
        <div>
           <p><strong className='text-xs'>ADDRESS:</strong> Hlm Grand Yoff Villa n°241.</p>
        </div>
        <div>
        <p><strong  className='text-xs'>PHONE:</strong> +84 1102 2705</p>
        </div>
        <div>
        <p><strong  className='text-xs'>Email:</strong> hello@thebox.com</p>
        </div>
     ...
     {/* deuxieme div */}
      <div className='flex flex-col gap-6'>
      <div>
      <label htmlFor="newsletter" className="block text-sm/6 font-medium text-gray-900">NEWSLETTER:</label>
    ...
    <div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-yellow-700">
      <input type="email" name="newsletter" id="newsletter" className="block w-fullmin-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="you@example.com"/>
    </div>
     <div className='mt-2'>
