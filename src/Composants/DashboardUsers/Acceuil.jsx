...
export const Acceuil = () => {
  ...
  return (
    <div className="p-2 text-[var(--primary-color)] w-full lg:w-[50%] flex flex-col gap-5">
      {fakeDocuments.map((doc) => (
        <div
          key={doc.id}
          className="document  w-full shadow-2xl p-5 lg:p-10 bg-white"
        >
          ...
          <div className="pdf p-2 lg:p-5 bg-white">
            <img
              src={doc.img}
              alt=""
              className="max-h-[300px] w-full object-fit: cover"
            />
          </div>
          ...
          <div
            className="flex justify-around lg:justify-between items-center gap-2
          ...
          >
            ...
            >
              ...
              <span className="hidden lg:block text-sm">
                <Buttons text={"Commenter"} />
              </span>
            </p>
            <p className="flex gap-2 items-center text-xl cursor-pointer">
              <FaEye />
              <span className="hidden lg:block text-sm">
                <Buttons text={"Voir Commentaire"} />
              </span>
            </p>
            <p className="flex gap-2 items-center text-xl cursor-pointer">
              <FaCloudUploadAlt />
              <span className="hidden lg:block text-sm">
                <Buttons text={"Telecharger"} />
              </span>
            </p>
          </div>
          {/* appel de modal */}
