...
export const Acceuil = () => {
  const {filteredPublications}= usePublication()
  
  const sortedPublications = filteredPublications.slice().sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));

    return <div className="py-6 px-4 flex flex-col items-center">
      <div className="titles mb-10">
        <h1 className="text-3xl font-[var(--font-title)]">Les derniers Rapports publiés</h1>
      </div>
