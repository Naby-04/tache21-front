...
<p>Après avoir envoyé ce formulaire, vous recevrez un <span className="font-bold">Email</span>  contenant un code pour réinitialiser votre mot de passe.</p>
        ...
        <Link to="/ReinitialiserMdp" className="w-full  mt-7">
          <button
