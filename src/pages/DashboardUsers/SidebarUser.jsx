...
import { FaCloudUploadAlt, FaDochub, FaEdit, FaHome, FaTrash } from "react-icons/fa";

export const SidebarUser = () => {

    
	return (
		<div className=" w-full lg:w-[400px] p-5 bg-[var(--background-color)] 
        text-[var(--primary-color)] shadow-2xl h-screen
          hidden lg:block sticky top-0"  
        id="sidebar">
			<Profile />
			<hr className="mt-5 h-[8px] w-full bg-[var(--primary-color)]" />
			<ul className="list-unstyled flex flex-col mt-5 gap-3 cursor-pointer">
				<li className="text-2xl font-[var(--weight-semi-bold)] flex gap-2 items-center"><FaHome /> Acceuil</li>
				<li className="text-2xl font-[var(--weight-semi-bold)] flex gap-2 items-center">
