...
const Connexion = () => {
  return (
    <div className='h-screen flex items-center px-20' style={{
    ...
    <div  className="bg-white shadow-md hc rounded px-8 pt-6 pb-8 flex flex-col w-full max-w-sm mx-auto">
      ...
      {/* <div className="flex items-center justify-between"> */}
        <a className="inline-block text-end  font-bold text-sm text-blue-500 hover:text-blue-800 mb-6" href="/mot-de-passe-oublie">
          Mot de passe oublié ?
        </a>
          <button
      ...
      <div className="my-4 border-b-2">
        <div className="text-center relative top-3 bg-white size-fit mx-auto px-3">OU</div>
      </div>
